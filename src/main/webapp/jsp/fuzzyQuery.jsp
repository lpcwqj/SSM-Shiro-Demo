...
<div style="padding: 0px 10px 10px 10px;">
    <form id="form0" name="form1" method="post" action="fuzzyQuery">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <button class="btn btn-default"><a href="home">返回主页</a></button>
        <table align="right">
            <tr>
...
<form id="form1" name="form1" method="post" action="batchDeletion">
    <table class="table table-hover" border="1px" style="border-color: #e9f5e3;font-size: 14px">
        ...
        <c:forEach var="user" items="${page1.list}">
            <tr align="center">
                ...
                <td><button class="btn btn-default" onclick="deleteUser(${user.id})"><a>删除</a></button></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <table align="center">
        <tr>
            <td>
                当前是第 ${page1.currentPage} 页, 共 ${page1.totalPage} 页和 ${page1.totalRecord} 条记录.
                每页显示 ${page1.pageSize} 条记录.
                <ul class="pager">
                <c:if test="${page1.currentPage != 1}">
                    <li><a href="fuzzyQuery?currentPage=1">首页</a></li>&nbsp;&nbsp;
                    <li><a href="fuzzyQuery?currentPage=${page1.currentPage-1}">上一页</a></li>&nbsp;&nbsp;
                </c:if>
                <c:if test="${page1.currentPage != page1.totalPage}">
                    <li><a href="fuzzyQuery?currentPage=${page1.currentPage+1} ">下一页</a></li>&nbsp;&nbsp;
                    <li><a href="fuzzyQuery?currentPage=${page1.totalPage}">尾页</a></li>
                </c:if>
                </ul>
            </td>
        </tr>
